...
function louden_scripts()
{
  if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
    ...
    wp_register_script('tweenmax', get_template_directory_uri() . '/_inc/js/lib/TweenMax.js', array(), '1.0.0');
    wp_register_script('tweenmax-css', get_template_directory_uri() . '/_inc/js/lib/CSSPlugin.min.js', array(), '1.0.0');
    wp_register_script('tweenmax-scrollto', get_template_directory_uri() . '/_inc/js/lib/ScrollToPlugin.min.js', array(), '1.0.0');
    wp_register_script('jquery', get_template_directory_uri() . '/_inc/js/lib/jquery.min.2.1.1.js', array(), '2.1.1');
    wp_register_script('scrollmagic', get_template_directory_uri() . '/_inc/js/lib/class.ScrollMagic.js', array('jquery'), '1.0.0');
    wp_register_script('scrollscene', get_template_directory_uri() . '/_inc/js/lib/class.ScrollScene.js', array('jquery'), '1.0.0');
    wp_register_script('scrolldebug', get_template_directory_uri() . '/_inc/js/lib/class.ScrollScene.extend.debug.js', array('jquery'), '1.0.0');
    wp_register_script('isotope', get_template_directory_uri() . '/_inc/js/lib/isotope.pkgd.min.js', array(), '1.0.0');
    wp_register_script('isotope-hor', get_template_directory_uri() . '/_inc/js/lib/masonry-horizontal.js', array(), '1.0.0');
    wp_register_script('images-load', get_template_directory_uri() . '/_inc/js/lib/imagesloaded.pkgd.min.js', array(), '1.0.0');
    wp_register_script('lightgallery', get_template_directory_uri() . '/_inc/js/lib/lightGallery.js', array(), '1.0.0');
    wp_register_script('easing', get_template_directory_uri() . '/_inc/js/lib/jquery.easing.1.3.js', array('jquery'), '1.0.0');
    wp_register_script('utillls', get_template_directory_uri() . '/_inc/js/lib/utils.js', array('jquery'), '1.0.0');
    wp_register_script('preloader', get_template_directory_uri() . '/_inc/js/lib/pace.min.js', array('jquery'), '1.0.0');
