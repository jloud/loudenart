...
function main_nav()
{
	...
	array(
		...
		'link_before'     => '',
		'link_after'      => '',
		'items_wrap'      => '<ul id="nav-list" class="nav-list">%3$s</ul>',
		'depth'           => 0,
		'walker'          => ''
		)
	);
...
function html5blank_header_scripts()
{
  if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
    ...
    wp_register_script('tweenmax', get_template_directory_uri() . '/js/lib/TweenMax.js', array(), '1.0.0');
    wp_register_script('tweenmax-css', get_template_directory_uri() . '/js/lib/CSSPlugin.min.js', array(), '1.0.0');
    wp_register_script('tweenmax-scrollto', get_template_directory_uri() . '/js/lib/ScrollToPlugin.min.js', array(), '1.0.0');
    wp_register_script('jquery', get_template_directory_uri() . '/js/lib/jquery.min.2.1.1.js', array(), '2.1.1');
    wp_register_script('scrollmagic', get_template_directory_uri() . '/js/lib/class.ScrollMagic.js', array('jquery'), '1.0.0');
    ...
    wp_register_script('isotope-hor', get_template_directory_uri() . '/js/lib/masonry-horizontal.js', array(), '1.0.0');
    wp_register_script('images-load', get_template_directory_uri() . '/js/lib/imagesloaded.pkgd.min.js', array(), '1.0.0');
    ...
    //wp_register_script('panelsnap', get_template_directory_uri() . '/js/lib/jquery.panelSnap.js', array('jquery'), '1.0.0');
    wp_register_script('scrollstop', get_template_directory_uri() . '/js/lib/jquery.scrollstop.js', array('jquery'), '1.0.0');
    wp_register_script('scrollsnap', get_template_directory_uri() . '/js/lib/jquery.scrollsnap.js', array('jquery'), '1.0.0');
    wp_register_script('easing', get_template_directory_uri() . '/js/lib/jquery.easing.1.3.js', array('jquery'), '1.0.0');
    wp_register_script('blur', get_template_directory_uri() . '/js/lib/Vague.js', array('jquery'), '1.0.0');
    ...
    wp_register_script('smooth-state', get_template_directory_uri() . '/js/lib/jquery.smoothState.js', array('jquery',), '1.0.0', true);
